...
Infopro Challenge is Table build in React that uses a node.js Api with Express server to get the data from the SQL database
...
<code>git clone https://github.com/martapunset/infopro-react-table-API</code>
...
The server should be running now on PORT 4000</div>
